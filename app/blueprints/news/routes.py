...
# Tworzenie Blueprinta dla funkcji związanych z artykułami
news_bp = Blueprint(
    'news_bp',  # Nazwa Blueprinta
    __name__,   # Nazwa modułu
    static_folder='static',  # Ścieżka do folderu z plikami statycznymi
    template_folder='templates'  # Ścieżka do folderu z szablonami HTML
)
...
def news_home():
    ...
    page = request.args.get('page', 1, type=int)  # Pobranie numeru strony z parametrów URL
...
def news_preview():
    ...
    # Renderowanie szablonu podglądu najnowszych artykułów
